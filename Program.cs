...
namespace NinetiesTV
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Print("NumShowsFromRandomRange", NumShowsFromRandomRange(shows));
            Print("Binge Time", BingeTime(shows));
            Print("HighestYearIMbd", HighestYearIMbd(shows));
        ...
        **************************************************************************************************/
        ...
        public static int HighestYearIMbd(List<Show> shows)
        {
            return shows
